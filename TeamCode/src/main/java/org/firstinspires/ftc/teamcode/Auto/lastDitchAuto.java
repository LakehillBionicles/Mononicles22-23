...
@Autonomous(name="lastDitchAuto", group = "robot")
public class lastDitchAuto extends LinearOpMode {
...
//        {
 ...
 //       }
       ...
       // telemetry.addData("Starting at", "%7d :%7d",
        ...
        /*
        //score cone on tallest post (comes after above section)
        encoderDrive(.5, 6, 6, 5);
        strafeDrive(.5, 36, 36, 5);
        encoderArmUp(1, 33.5, 5);
        openHand();
