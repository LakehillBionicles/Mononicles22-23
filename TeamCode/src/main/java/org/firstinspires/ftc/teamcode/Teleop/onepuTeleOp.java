...
@TeleOp(name="onepuTeleOp", group="robot")
//@Disabled
public class onepuTeleOp extends LinearOpMode {
    ...
    public void drive() {
        if (gamepad1.left_stick_x < 0.2 && gamepad1.left_stick_x > -0.2 && gamepad1.left_stick_y < -0.5) {   //forward
        ...
        } else if (gamepad1.left_stick_x > -0.2 && gamepad1.left_stick_x < 0.2 && gamepad1.left_stick_y > 0.5) {   //backwards
            robot.fpd.setPower(-gamepad1.left_stick_y);
            robot.bpd.setPower(-gamepad1.left_stick_y);
            robot.fsd.setPower(-gamepad1.left_stick_y);
            robot.bsd.setPower(-gamepad1.left_stick_y);
